...
export default function StudentDashboard() {
  ...
  const totalCreditsRequired = profileData?.student?.totalCreditsRequired || 120;
      ...
      <div className="p-4 md:p-6">
        <div className="mb-6">
          ...
          <p className="text-gray-600">
            Xin chào, <span>{user?.fullName || "Sinh viên"}</span>! Chào mừng trở lại.
          </p>
        </div>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  {isLoadingEnrollments ? (
                    ...
                    <p className="text-lg font-semibold">{currentCoursesCount} môn</p>
                  )}
                </div>
              </div>
            </CardContent>
              ...
              <div className="flex items-center">
                ...
                <div>
                  ...
                  {isLoadingProfile ? (
                    ...
                    <p className="text-lg font-semibold">{creditsCompleted}/{totalCreditsRequired} tín chỉ</p>
                  )}
                </div>
              </div>
            </CardContent>
                ...
                <div className="divide-y divide-gray-200">
                  ...
                  <div className="p-4 hover:bg-gray-50">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <h4 className="text-sm font-medium">Lịch thi cuối kỳ đã được cập nhật</h4>
                  ...
                  <div className="p-4 hover:bg-gray-50">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <h4 className="text-sm font-medium">Điểm quá trình môn Lập trình Web đã được cập nhật</h4>
                  ...
                  <div className="p-4 hover:bg-gray-50">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <h4 className="text-sm font-medium">Mở đăng ký học phần học kỳ tới</h4>
                  ...
                  <div className="p-4 hover:bg-gray-50">
                    <div className="flex items-start">
                      ...
                      <div className="flex-1">
                        <h4 className="text-sm font-medium">Nhắc nhở thanh toán học phí</h4>
