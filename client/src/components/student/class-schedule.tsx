...
export function ClassSchedule({ limit = 3, showViewAll = true, date = new Date() }: ClassScheduleProps) {
  ...
  return (
    <Card>
      <CardHeader className="px-4 py-3 border-b border-gray-200 flex justify-between items-center">
        <CardTitle className="text-base font-semibold">Lịch học hôm nay</CardTitle>
        {showViewAll && (
          <a href="/student/schedule" className="text-sm text-primary hover:underline">
            Xem tất cả
          </a>
        )}
      </CardHeader>
      <CardContent className="p-0">
        {isLoading ? (
              ...
              <div key={index} className="p-4 flex items-start">
                ...
                <div className="flex-1">
                  ...
                  <div className="flex items-center text-sm text-gray-600 mb-1">
                    ...
                    <span>GV. {classItem.facultyName || "..."}</span>
                  </div>
          ...
          <div className="p-8 text-center">
            <p className="text-gray-500">Không có lịch học nào cho hôm nay</p>
          </div>
        )}
      </CardContent>
    </Card>
