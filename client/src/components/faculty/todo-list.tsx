  ...
  return (
    <Card>
        ...
        <Dialog open={open} onOpenChange={setOpen}>
          ...
          <DialogContent>
            ...
            <div className="space-y-4 py-2">
              ...
              <Button onClick={handleAddTodo} className="w-full">Thêm</Button>
            </div>
          </DialogContent>
        </Dialog>
      </CardHeader>
      <CardContent className="p-4">
            ...
            <div key={todo.id} className="flex items-center">
              ...
              <div className="flex-1">
                <label 
                  ...
                  className={`block text-sm font-medium ${todo.completed ? 'line-through text-gray-400' : ''}`}
                >
                  {todo.text}
                </label>
                <p className={`text-xs ${todo.deadline.includes('Hôm nay') ? 'text-red-500' : 'text-gray-500'}`}>
        ...
        <Button variant="ghost" size="sm" className="mt-4 text-xs text-gray-500 hover:text-gray-700 flex items-center">
